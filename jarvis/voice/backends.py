...
from jarvis.voice.tts import MockTTSBackend, PiperTTSBackend, TTSManager
from jarvis.voice.wakeword import FuzzyWakeDetector, KeywordWakeDetector, WakeWordDetector
...
def build_tts_manager(config: JarvisConfig, limits: VoiceLimits) -> TTSManager:
    ...
    if engine == "offline":
        from jarvis.voice.tts import OfflineTTSBackend
